...
import {type Workshop, type WorkshopCategory, WorkshopService} from "$lib/services/WorkshopService";
import {
...
export const load: PageServerLoad = async ({ locals }) => {
  ...
  const categories: WorkshopCategory[] = await workshopService.getAllCategories();
