...
const adapter = new NodePostgresAdapter(pool, { user: "users", session: "user_session" });

export const github = new GitHub(env.PRIVATE_GITHUB_CLIENT_ID, env.PRIVATE_GITHUB_CLIENT_SECRET, "http://localhost:5173/auth/callback/github");
