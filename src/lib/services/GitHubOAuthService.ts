...
export class GitHubOAuthService {
    ...
    async getUserByGitHubId(gitHubId: string): Promise<null | {id: number, githubId: number}> {
    ...
    async createUser(gitHubId: string, name: string, email: string): Promise<string> {
